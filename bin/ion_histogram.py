...
def _main():
    ...
    p.add_option('--o-histogram', dest='fn_histogram',
                 default="histogram.txt",
                 help="output file name for histogram.")
    ...
    p.add_option('--grid-w-h', dest='grid_width_h',
                 type="float",
                 default=0.01,
                 help="grid width in h axis for histogram")
    p.add_option('--grid-w-r', dest='grid_width_r',
                 type="float",
                 default=0.01,
                 help="grid width in r axis for histogram")
    ...
    if opts.flg_verbose:
        print "output " + opts.fn_histogram

    for atom in opts.atomnames:
        output_grid(opts.fn_histogram+'.'+atom, grid[atom],
                    opts.grid_width_h, opts.grid_width_r,
